...
from crosswords.decryptor.DPR.transformers3.src.transformers3.modeling_bert import BertConfig, BertModel
from crosswords.decryptor.DPR.transformers3.src.transformers3.modeling_electra import ElectraConfig, ElectraModel
from crosswords.decryptor.DPR.transformers3.src.transformers3.modeling_roberta import RobertaConfig, RobertaModel
from crosswords.decryptor.DPR.transformers3.src.transformers3.optimization import AdamW
from crosswords.decryptor.DPR.transformers3.src.transformers3.tokenization_bert import BertTokenizer
from crosswords.decryptor.DPR.transformers3.src.transformers3.tokenization_roberta import RobertaTokenizer
from crosswords.decryptor.DPR.transformers3.src.transformers3.tokenization_electra import ElectraTokenizer

from crosswords.decryptor.DPR.dpr.utils.data_utils import Tensorizer
from crosswords.decryptor.DPR.dpr.models.biencoder import BiEncoder
from crosswords.decryptor.DPR.dpr.models.reader import Reader
    ...
    def __init__(self, config, project_dim: int = 0):
        ...
        self.encode_proj = (
            nn.Linear(config.hidden_size,
                      project_dim) if project_dim != 0 else None
        )
        self.init_weights()
...
class HFRobertaEncoder(RobertaModel):
    ...
    def init_encoder(
        ...
        cfg = RobertaConfig.from_pretrained(
            cfg_name if cfg_name else "roberta-large")
        if dropout != 0:
            cfg.attention_probs_dropout_prob = dropout
            cfg.hidden_dropout_prob = dropout
        return cls.from_pretrained(
...
class HFElectraEncoder(ElectraModel):
    ...
    def init_encoder(
        ...
        cfg = ElectraConfig.from_pretrained(
            cfg_name if cfg_name else "google/electra-large-discriminator")
        if dropout != 0:
            cfg.attention_probs_dropout_prob = dropout
            cfg.hidden_dropout_prob = dropout
        print(cfg_name)
